...
for (page in 1:3) {
  url <- paste0("https://espaciopublico.cl/categoria/prensa/ep-en-la-prensa/carta-al-director/page/", page, "/")
...
write.xlsx(df, file = "EP Cartas al Director.xlsx", rowNames = FALSE)
