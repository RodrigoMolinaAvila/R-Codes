...
for (i in 1:36) {
  url_pagina <- paste0("https://fppchile.org/categoria/noticias/page/", i, "/")
...
write.xlsx(df_info, "FPP - Noticias.xlsx", rowNames = FALSE)

cat("Extracción de Noticias FPP completada.\n")
