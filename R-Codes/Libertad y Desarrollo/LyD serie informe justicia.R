...
url_base <- "https://lyd.org/category/estudios/estudios-lyd/serie-informe-justicia/page/"
...
write.xlsx(datos_totales, file = "Serie Informe Justicia LyD.xlsx", rowNames = FALSE, encoding = "UTF-8")
