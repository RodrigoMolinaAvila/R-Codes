...
url_base <- "https://lyd.org/category/estudios/estudios-lyd/serie-informe-social/page/"
...
write.xlsx(datos_totales, file = "Serie Informe Social LyD.xlsx", rowNames = FALSE, encoding = "UTF-8")
