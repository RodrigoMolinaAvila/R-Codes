...
url_base <- "https://lyd.org/category/estudios/estudios-lyd/serie-informe-medio-ambiente/page/"
...
write.xlsx(datos_totales, file = "Serie Informe Medio Ambiente LyD.xlsx", rowNames = FALSE, encoding = "UTF-8")
