...
url_base <- "https://lyd.org/category/estudios/estudios-lyd/serie-informe-legislativo/page/"
...
write.xlsx(datos_totales, file = "Serie Informe Legislativo LyD.xlsx", rowNames = FALSE, encoding = "UTF-8")
