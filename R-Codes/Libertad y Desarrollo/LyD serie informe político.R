...
url_base <- "https://lyd.org/category/estudios/estudios-lyd/serie-informe-politico/page/"
...
write.xlsx(datos_totales, file = "Serie Informe Político LyD.xlsx", rowNames = FALSE, encoding = "UTF-8")
