...
url_base <- "https://lyd.org/category/estudios/resena-legislativa/page/"
...
write.xlsx(datos_totales, file = "Reseña Legislativa LyD.xlsx", rowNames = FALSE, encoding = "UTF-8")
